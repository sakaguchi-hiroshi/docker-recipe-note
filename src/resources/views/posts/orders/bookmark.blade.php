@extends('layouts.app')
  ...
  @section('pageCss')
    <link rel="stylesheet" href="{{ asset('/assets/css/posts/bookmark.css')}}">
  @endsection
  @include('layouts.header.first')
  @include('layouts.header.second')
  @section('main')
    <h2 class="main-headline">人気レシピランキング</h2>
    <form class="search-form" action="{{ route('posts.orders.bookmark') }}" method="get">
      @csrf
